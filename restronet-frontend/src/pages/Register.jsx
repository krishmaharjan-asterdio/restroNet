...
import { Mail, Lock, Eye, EyeOff, Utensils, User as UserIcon } from 'lucide-react';
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-3/5 relative flex-col items-center justify-center overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 text-center px-12 max-w-lg">
          ...
          <h2 className="text-3xl font-bold text-white mb-4 leading-snug">
            Join the community<br />of food lovers
          </h2>
          <p className="text-gray-300 text-lg leading-relaxed">
            Create an account to unlock personalized recommendations tailored to your taste.
          </p>
      ...
      <div className="w-full md:w-1/2 lg:w-2/5 flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Join the RestroNet community today</p>
